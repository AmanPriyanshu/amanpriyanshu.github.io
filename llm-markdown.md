...
### [GPT-OSS Expert Fingerprinting: 232 Specialized Models via MoE Pruning](https://github.com/AmanPriyanshu/GPT-OSS-MoE-ExpertFingerprinting/)
Released 232 domain-specialized models from 4.2B to 20B (downloaded 25K+ times within 6 months of release) by analyzing expert activation patterns in GPT-OSS-20B's MoE architecture and strategically pruning underutilized experts.
